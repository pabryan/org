...
| Pay                    | -3800 |
| Weekly Food            |   408 |
| Supermarket (non-food) |    60 |
| Supermarket (bulk)     |    24 |
|                        |       |
| Total                  |  -818 |
   #+TBLFM: @11$2=remote(WeeklyFood,@17$2)*4::@13$2=remote(MonthlyFood,@8$2)::@15$2=vsum(@2$2..@14$2)
...
** TODO plan weekly food
   - State "DONE"       from "NEXT"       [2012-11-20 Tue 09:48]
   :PROPERTIES:
   :ID:       659b82d1-fff2-498c-afeb-3101030d6946
   :LAST_REPEAT: [2012-11-20 Tue 09:48]
   :END:
...
** TODO Track health stats
   ...
   :END:
*** NEXT Create project for tracking
    :PROPERTIES:
    :ID:       5f12ccf7-644f-4c85-8979-e952533a6773
    :END:
*** TODO Determine quantities to track
    :PROPERTIES:
    :ID:       63f0ea65-632e-4656-aa48-b082021d965a
    :END:
*** TODO Determine how to track quantities
    :PROPERTIES:
    :ID:       4d092569-138f-4d2c-98be-154ea7c43f02
    :END:
*** TODO Get data into org-mode
    :PROPERTIES:

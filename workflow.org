...
** NEXT Weekly Review [19/20]
   SCHEDULED: <2015-01-09 Fri +1w>
   :LOGBOOK:
...
- [X] Plan the upcoming week
  ...
  - [X] Schedule tasks for the week. See [[file:goals.org::*Weekly%20time][Weekly time]].
    - [X] Teaching
      - [X] lecture planning
      - [X] exam writing
      - [X] office hours
      - [X] lectures
      - [X] online discussion (piazza)
      - [X] blog
      - [X] general admin
    - [X] Research
      - [X] writing	
    ...
    - [X] Coding
      ...
      - [X] plots   
    - [X] Organisation
      - [X] Weekly review: Friday afternoon's!
      - [X] Project planning
- [X] Review focus projects 
- [X] Set focus
- [X] Check follow-up paper folder
- [X] Collate the weeks: pad scribbles, org-mode notes, phone notes, etc.
- [X] Check Finances

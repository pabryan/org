...
*** 26D (1980-now) Inequalities [For maximal function inequalities, see 42B25; for functional inequalities, see 39B72; for probabilistic inequalities, see 60E15] :INEQUALITIES:
...
**** 35K55   (1973-now) Nonlinear parabolic equations		  :NONLINEAR:
...
** 53 (1940-now) Differential geometry [For differential topology, see 57Rxx. For foundational questions of differentiable manifolds, see 58Axx] :DG:MANIFOLDS:RIEMANNIAN:GEOMETRY:
...
**** 53A10 Minimal surfaces, surfaces with prescribed mean curvature :MINIMAL_SURFACES:MEAN_CURVATURE:
...
**** 53A07   (1980-now) Higher-dimensional and -codimensional surfaces in Euclidean n-space
***** Deforming a hypersurface by its {G}auss-{K}ronecker curvature
:PROPERTIES:
:Custom_ID: MR812353
:END:
...
***** A geometric interpretation of {H}amilton's {H}arnack inequality for the {R}icci flow
:PROPERTIES:
:Custom_ID: MR1362964
:END:
[[papers:MR1362964][MR1362964-paper]]
[[bib:MR1362964][MR1362964-bib]]
***** Aleksandrov reflection and nonlinear evolution equations. {I}. {T}he {$n$}-sphere and {$n$}-ball
:PROPERTIES:
:Custom_ID: MR1386736
:END:
...
***** Closed type {I} ancient solutions to {R}icci flow
:PROPERTIES:
:Custom_ID: MR2648942
:END:
...
**** 58E11   (1980-now) Critical metrics
***** The {H}arnack estimate for the {R}icci flow
:PROPERTIES:
:Custom_ID: MR1198607
:END:
...
**** 58G30   (1980-1999) Relations with special manifold structures (Riemannian, Finsler, etc.)

...
******* DONE Work out algorithm 
	...
	:END:
******* NEXT Refactor code into clean code
	:LOGBOOK:
	CLOCK: [2014-03-31 Mon 17:31]--[2014-03-31 Mon 17:52] =>  0:21
	:END:
****** TODO Code structure
******* TODO Set up classes for computation
...
******** NEXT Split up parameters
	 :LOGBOOK:
	 CLOCK: [2014-04-04 Fri 15:19]
	 :END:
...
******** NEXT Group related parameters together
A's go together, Wavelengths go together
******** NEXT Split computational parameters from initialisation
...
- We should also have some way of computing gradients, divergence, Laplacian etc. from the metric. This is dependent on the manifold as well and hence the atlas. For the mesh, we shouldn't have to anything different say for meshes of different sizes as long as they are meshes for the same atlas.
******* Simulations
Once we have a spacetime, we 

...
******** NEXT Sort out conservation equations/Material derivative/Lie derivative
...
- Well balancing
- ANUGA
**** TODO Minimal immersion in hyperbolic space
***** Notes
***** Tasks
***** Meetings
****** Nolan Wallach
...
*** DONE Write list of publications
    ...
    :END:
*** TODO 2014
**** TODO Update application documents
...
***** DONE Update teaching statement
      ...
      :END:
***** NEXT Update publication list
***** NEXT Upload documents to mathjobs.org
* Visiting
** Tasks
** People
*** Mu-Tao Wang

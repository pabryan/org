...
*** TODO Review MR3018176					      :FOCUS:
    DEADLINE: <2013-07-12 Fri>
    :PROPERTIES:
...
*** NEXT Referee An application of dual convex bodies to the inverse Gauss curvature flow :FOCUS:
...
****** NEXT Write as viscosity equation
       :LOGBOOK:
...
****** TODO Find comparison solutions
       ...
       :END:
******* NEXT Try compare viscosity equation with angenent oval
	:PROPERTIES:
	:ID:       aec792bb-f6a8-4278-8efc-843bd1ab0500
	:END:
...
****** NEXT Properties of optimal points
       :PROPERTIES:
       :ID:       fa315975-ce59-4b0c-954b-fa15436dac58
       :END:
Is there something that can be deduced by inequalities in the barrier sense? E.g. something like Bavard/Pansu and Sternberg/Zunbrum.
****** NEXT Shorten introduction!
       :PROPERTIES:
       :ID:       fd104b00-d994-4de3-91b9-cdb9f2b02d15
       :END:
Maybe give the result first and then discuss (briefly) the history.
****** NEXT Add a section on chord/arc-profile
       :PROPERTIES:
       :ID:       cc7a64a2-bc18-4f6b-a239-289231e67efe
       :END:
- Asymptotics
- Concavity properties (if any) using upper barriers
...
****** NEXT Work out support function parametrisation
       ...
       :END:
- Check what Ben and Chen did in $\HH^3$.
- i.e. construct a parametrisation from the support function.
- Is it true that $\exp_O (s(x)\nor(x) + T(x)) = x$ with $T(x) = \grad s$ tangent? No. This is the Wulf shape and is only the original hypersurface when $s$ is defined using the position vector field.
...
- How does this relate to the original hypersurface? In particular how do the curvatures relate?
...
**** TODO Write proof of viscosity equation for dist-comp Z
     :PROPERTIES:
...
***** NEXT Compute time variation
      ...
      :END:
***** NEXT Compute Spatial variation
      :PROPERTIES:
...
**** WAITING Submit reimbursement form
     DEADLINE: <2013-06-02 Sun> SCHEDULED: <2013-06-02 Sun>

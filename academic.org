...
*** NEXT Review MR3259043
    DEADLINE: <2014-12-13 Sat> SCHEDULED: <2014-11-17 Mon>
    :LOGBOOK:
    CLOCK: [2014-11-23 Sun 09:45]--[2014-11-23 Sun 10:30] =>  0:45
    :END:
...
******* WAITING Update based on referee comments
******* NEXT Add isoperimetric inequality method
...
******** NEXT Approximation by constant density
******** NEXT Add friction according to Manning-Strickler
- near eq 2.49 p. 233 of bourdarias, ersoy, gerbi
...
******** TODO Show $\int F(A) \to 0$
******** TODO Show $\int_t^{-\infty} F(A(x,t)) < \infty$ for each $x$
...
****** TODO Maths
******* TODO Curvature goes to 0
******** NEXT Show pointwise by curve lengths
...
******* TODO Harnack inequality
******** NEXT Evolution of support function.
See [[*Convexity%20in%20space%20forms][Convexity in space forms]] and Ben's argument.
****** TODO Writing
...
***** NEXT Max Planck
     ...
     :END:
http://www.mis.mpg.de/institute/application/postdoc

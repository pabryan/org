...
****** TODO Write notes
******* NEXT Write notes on Sec 1
******* NEXT Write notes on Sec 2
******* NEXT Write notes on Sec 3
******* NEXT Write notes on Sec 4
******* NEXT Write notes on Sec 5
******* NEXT Write notes on Sec 6
****** NEXT Compile report
...
******* DONE Write details of convergence to equator
	...
	:END:
******* NEXT Write convergence to a graph
...
******* NEXT Created titled reflection figure
	...
	:END:
******* TODO Compile first draft
	 SCHEDULED: <2014-05-19 Mon>
******* TODO Produced final version
...
******* DONE Proof read statement
	...
	:END:
******* WAITING Send to Christine for comments
	:LOGBOOK:
	- State "WAITING"    from "TODO"       [2014-05-27 Tue 15:56] \\
	  Waiting on comments.
	:END:
******* TODO Update based on comments
******* NEXT Write cover letter

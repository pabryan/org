...
****** NEXT Create pictures of isoperimetric domains
       :LOGBOOK:
...
******* NEXT Write paper outline
	...
	:END:
******* NEXT Incorporate Janelle's work
...
******* NEXT Refactor code into clean code
	:LOGBOOK:
	CLOCK: [2014-03-31 Mon 17:31]
	:END:
****** TODO Code structure
******* NEXT Set up classes for computation
...
****** TODO Numerics
******* NEXT Investigate best use of numpy arrays, lists etc.
       	:LOGBOOK:
...
***** Files
[[file:~/working/academic/research/wdm/sage/spiralgalaxy]]
*** Future							    :SOMEDAY:
**** TODO ANUGA
     :PROPERTIES:

...
****** CANCELLED Write hessian of d at minimiser and eigenvectors of $M_{\pm}$
       - State "CANCELLED"  from "NEXT"       [2013-07-11 Thu 15:41] \\
	 Not useful. We need the hessian of $Z$ at the minimiser which I've alredy got in the viscosity equation.
...
****** NEXT Mention that we use a null-eigenvector 
       :LOGBOOK:
       CLOCK: [2013-07-12 Fri 15:37]
       :END:
Need to rename this: Fix up spatial viscosity equation.

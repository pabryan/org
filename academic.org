...
****** NEXT Make lemma with differentials at the minimiser
- Write out D^2d at the minimiser in its own lemma.
- Also write out consequence of vanishing first variation in same lemma.
****** NEXT Write viscosity equation without specifying curvature integral bounds
       :LOGBOOK:
       CLOCK: [2013-07-11 Thu 10:24]
       :END:
...
****** NEXT Work out barrier inequality
       :LOGBOOK:
...
****** NEXT Mention somewhere that $p_0\ne q_0$ since $\ell \ne 0$.
****** NEXT Mention that we use a null-eigenvector 
To cancel various things we use a null eigenvector of $M_+,M_-$.
****** TODO Clean up text

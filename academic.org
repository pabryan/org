...
**** NEXT Produce CEJM-D-13-00091 report
     DEADLINE: <2014-02-08 Sat>
     :LOGBOOK:
     CLOCK: [2014-02-07 Fri 09:44]
     :END:
** Refereeing
...
******* NEXT Change small and large scale behaviour in comparison to use asysmptotics
	:PROPERTIES:
...
******* NEXT Change comparison theorem to explicitly use asymptotics
	...
	:END:
****** TODO Write comparison theorem without strict equality

...
**** TODO Ancient solutions on spheres :FLOWS:SPHERE:ANCIENT:INPROGRESS:WRITING:
...
******** NEXT Compute evolution of support function
	 :LOGBOOK:
	 CLOCK: [2015-01-20 Tue 10:00]--[2015-01-20 Tue 10:17] =>  0:17
	 :END:
******** NEXT Compute laplacian of support function
******* TODO Backwards convergence
******* TODO Aleksandrov reflection
***** Notes
****** TODO Check out Killing graphs preserved
...
**** TODO Convexity in space forms	:CONVEX:SPACEFORM:INPROGRESS:WRITING:
***** Files

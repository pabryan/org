...
**** TODO Ancient solutions on spheres	    :FLOWS:SPHERE:ANCIENT:INPROGRESS:
...
**** TODO Convexity in space forms		:CONVEX:SPACEFORM:INPROGRESS:
***** Files
...
******* TODO Proof reading
**** TODO CSF surfaces distance comparison :CSF:SURFACES:DIST_COMP:INPROGRESS:
   :PROPERTIES:

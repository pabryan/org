...
********* DONE Upload exam info to website
	  ...
	  :END:
********* NEXT Make link to MT1 solutions
	  :PROPERTIES:
...
******** NEXT Investigate reducing homework load
	 :PROPERTIES:
	 :ID:       239b327c-6035-4dbe-bc20-22838c0bbcee
	 :END:
******** NEXT Notify Laurel Bawling that MT1 grade stands
	 :PROPERTIES:
...
****** TODO Cover Adrian Ionoa's analysis lecture
       :PROPERTIES:
...
****** NEXT Check on research program credit requirements
...
**** NEXT Send DG seminar email announcement
    ...
    :LAST_REPEAT: [2013-10-24 Thu 11:42]
    :END: 

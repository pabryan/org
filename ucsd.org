...
3. $$\frac{-x}{2} + \frac{\sqrt{x^4 + 4c x}{2x}, x < - (4c)^{1/3}$$
4. $$\frac{-x}{2} - \frac{\sqrt{x^4 + 4c x}{2x}, x < - (4c)^{1/3}$$.

For $$c<0$$, we get much the same thing, but the inequalities in the range of $$x$$ are reversed.

...
**** DONE Links to papers
     ...
     :END:
**** NEXT Make teaching links use org-mode (not literal html)
     :PROPERTIES:
...
******* DONE Write Homework 2
	 DEADLINE: <2013-08-09 Fri>
	 - State "DONE"       from "NEXT"       [2013-07-31 Wed 14:41]
	:PROPERTIES:

...
********* DONE Post week 2 summary
	  ...
	  :Effort:   0:15
	  :END:
********* TODO Post week 3 summary
	  DEADLINE: <2014-08-24 Sun>
          :PROPERTIES:
	  :Effort:   0:15
	  :END:
********* TODO Post week 4 summary
	  DEADLINE: <2014-08-31 Sun>
          :PROPERTIES:
	  :Effort:   0:15
	  :END:
********* TODO Post week 5 summary
...
We need to sketch the graphs. To do this for curves 1. and 2., we need to know the limits as $$x\to 0$$ and $$x \to \infty$$. This is $$\infty$$ for 1. and $$-\infty$$ for 2. Both converge to $$0$$ as $$x \to \infty$$. You'll also need critical points and concavity which I'll leave to you to check. For 3. and 4. you need to evaluate the function at $$x = -(4c)^{1/3}$$ and calculate the limit as $$t\to -\infty$$ along with finding critical points and concavity. These last two items use the same calculation as for 1. and 2.

Here's a plot of the level curves for $$c = 1$$. I'll let you try to match the picture to the functions 1,2,3 and 4.
...
***** TODO MATH20D
      :LOGBOOK:
      CLOCK: [2014-08-12 Tue 16:07]--[2014-08-12 Tue 16:08] =>  0:01
      :END:

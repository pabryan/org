...
********** DONE Prepare lec 3.3
	   ...
	   :END:
********* TODO Week 4
********** NEXT Prepare lec 4.1
	   SCHEDULED: <2015-01-19 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 4.2
	   SCHEDULED: <2015-01-19 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 4.3
	   SCHEDULED: <2015-01-19 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:
********* TODO Week 5
********** NEXT Prepare lec 5.1
	   SCHEDULED: <2015-01-26 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 5.2
	   SCHEDULED: <2015-01-26 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 5.3
	   SCHEDULED: <2015-01-26 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:
********* TODO Week 6
********** NEXT Prepare lec 6.1
	   SCHEDULED: <2015-02-02 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 6.2
	   SCHEDULED: <2015-02-02 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 6.3
	   SCHEDULED: <2015-02-02 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:
********* TODO Week 7
********** NEXT Prepare lec 7.1
	   SCHEDULED: <2015-02-09 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 7.2
	   SCHEDULED: <2015-02-09 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:

********** NEXT Prepare lec 7.3
	   SCHEDULED: <2015-02-09 Mon>
	   :PROPERTIES:
	   :Effort:   1:00
	   :END:
...
******** DONE Check supplement homework
	 ...
	 :Effort:   1:30
	 :END:
******** NEXT Check supplement homework 2
	 DEADLINE: <2015-01-19 Mon>
	 :LOGBOOK:
	 CLOCK: [2015-01-19 Mon 10:30]
	 ...
	 :END:
********* Notes
- With just a brief glance, the message about $i$ looks the same for all questions, so students will probably only read the first one and thus assume they shouldn't have an $i$ in their answer.
- Submitting without constant gives a helpful error message. Then including the constant and submitting results in the message "This answer is equivalent to the one you just submitted." It appears to treat the answer as correct though. Submitting one more time (without changing the input), the message becomes "correct".
...
- Q3: Without a constant I don't get the helpful message about not being the most general solution. Also, the constant must be an upper case C, but in other questions, lower case is okay.
- Q6: Maybe mention the students need to include complex poles? Perhaps it's best to mention it for all such questions so we don't give away the answer.
- Q9: Should you mention that the constants could be complex? If so, perhaps mention it for all such questions.
...
********* DONE Write sample for MT1
	  ...
	  :LOGBOOK:
	  - State "DONE"       from "DONE"       [2015-01-15 Thu 10:41]
	  - State "DONE"       from "TODO"       [2015-01-15 Thu 10:41]
	  :END:
******** TODO Midterm 2
********* NEXT Write midterm 2
	  DEADLINE: <2015-02-13 Fri>
...
**** TODO Brian Lin
***** NEXT Write letter
***** TODO Send letter to admissions@atlanticbridge.com

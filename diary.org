...
*** 2013-10-24 Thursday
**** Log
- Gave a talk on Polar duals and inverse Gauss curvature flow. It seemed to be well received. I promised to give a follow-up talk on how the convergence works, which means I have to figure it out now!
- My 150A TA told me that the students are really enjoying the course, which makes a nice change!
- I have been able to prove that the comparison $\sqrt{v_C + bx^2}$ is concave. However, my latest computations indicate there is no way to ensure that it satisfies the required differential inequality. I'll need to more carefully check my computations since Ben seemed to think it would work. It's quite delicate trying to balance all the terms in the correct way!
